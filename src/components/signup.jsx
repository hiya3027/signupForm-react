  ...
  return (
    <div className="signup-container">
      ...
      <form className="signup-form" onSubmit={handleSubmit}>
        ...
        <label>
          Phone Number:
          <input type="tel" className="inputField" ref={phoneRef} placeholder="Enter 10-digit number" pattern="[0-9]{10}" required />
        </label>

        <label>
          Date of Birth:
          <input type="date" className="inputField" ref={dobRef} required />
        </label>

        <label>
          Country:
          <select className="inputField" ref={countryRef} required>
